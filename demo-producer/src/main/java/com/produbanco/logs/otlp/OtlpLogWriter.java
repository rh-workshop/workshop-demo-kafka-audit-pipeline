...
public final class OtlpLogWriter {
    ...
    private static final String SCOPE_NAME = "com.produbanco.logs";
    private static final String SERVICE_VERSION = "1.0.0";
    private static final String SERVICE_NAMESPACE = "produbanco.audit";
    private static final String EVENT_NAME = "com.produbanco.audit.transfer";
