...
public final class KeyDerivation {
    ...
    /// Contrato con `KeyDerivation.InfoV1` del .NET. El valor efectivo se lee de `KEY_INFO`; esta
    /// constante sirve de referencia y para congelar el vector de interoperabilidad en los tests.
    public static final String INFO_V1 = "produbanco/audit-log/aes256gcm/v1";
    ...
    private static final byte[] SALT = "produbanco.audit-log.salt.v1".getBytes(StandardCharsets.UTF_8);
